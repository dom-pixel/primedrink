...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="http://wemoga-001-site42.ftempurl.com/Content/images/favicon/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="http://wemoga-001-site42.ftempurl.com/Content/images/favicon/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="http://wemoga-001-site42.ftempurl.com/Content/images/favicon/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="http://wemoga-001-site42.ftempurl.com/Content/images/favicon/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="http://wemoga-001-site42.ftempurl.com/Content/images/favicon/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="http://wemoga-001-site42.ftempurl.com/Content/images/favicon/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="http://wemoga-001-site42.ftempurl.com/Content/images/favicon/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="http://wemoga-001-site42.ftempurl.com/Content/images/favicon/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="http://wemoga-001-site42.ftempurl.com/Content/images/favicon/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192" href="http://wemoga-001-site42.ftempurl.com/Content/images/favicon/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="http://wemoga-001-site42.ftempurl.com/Content/images/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="http://wemoga-001-site42.ftempurl.com/Content/images/favicon/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="http://wemoga-001-site42.ftempurl.com/Content/images/favicon/favicon-16x16.png">
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-sm-5">
                <div class="content-form-home">
                    <div>
                        <span class="text-form-01">
                            Cadastre sua distribuidora e decole!
                        </span>
                    </div>

                    <div class="m-t-10">
                        <span class="text-form-02">
                            Pensou em aumentar a rentabilidade do seu negócio?
                        </span>
                    </div>
                    ...
                    <div class="m-t-40">
                        <span class="text-form-03">
                            Nome Completo
                        </span>

                        <div>
                            <input class="form-control" type="type" name="name" value="" placeholder="Qual o nome completo do dono da distribuidora?">
                        </div>
                    </div>
                    ...
                    <div class="m-t-20">
                        ...
                        <div>
                            <input class="form-control" type="type" name="name" value="" placeholder="Qual o e-mail do dono da distribuidora?">
                        </div>
                    </div>
                    ...
                    <div class="m-t-20">
                        ...
                        <div>
                            <input class="form-control" type="type" name="name" value="" placeholder="Qual o Celular com DDD do dono da distribuidora?">
                        </div>
                    </div>

                    <div class="m-t-30">
                        <span class="text-form-04">
                            Ao continuar, aceito que a Prime Drink entre em contato comigo por telefone, whatsApp ou E-mail (Incluindo mensagens automáticas para credenciamento e ajuda do credenciado).
                        </span>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="text-center m-t-5">
                    <img style="width: 70px;" src="front/024.png">
                </div>
            </div>
        </div>
...
<section class="section" id="section-003">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <img style="width: 100%;" src="front/023.png">
            </div>
        </div>
    </div>
</section>
...
<section class="section" id="section-004">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" style="padding: 0px; visibility: visible; animation-duration: 1s; animation-delay: 0.1s;">
                <div class="module">
                    <div class="blog-image">
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <div style="max-width: 380px; margin: auto;">
                                        <div>
                                            <img style="width: 40px; display: inline;" src="front/004.png">
                            ...
                            <a class="left carousel-control" href="http://wemoga-001-site42.ftempurl.com/#myCarousel" role="button" data-slide="prev">
                                <span class="fa fa-angle-left" aria-hidden="true"></span>
                                <span class="sr-only">Previous</span>
                            </a>

                            <a class="right carousel-control" href="http://wemoga-001-site42.ftempurl.com/#myCarousel" role="button" data-slide="next">
            ...
            <div class="col-md-12">
                <div class="panel-group" id="accordion" style="max-width: 550px; margin: auto;">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title panel-title-questions">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="http://wemoga-001-site42.ftempurl.com/#collapseOne">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title panel-title-questions">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="http://wemoga-001-site42.ftempurl.com/#collapseTwo">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title panel-title-questions">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="http://wemoga-001-site42.ftempurl.com/#collapseThree">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title panel-title-questions">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="http://wemoga-001-site42.ftempurl.com/#collapseFor">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title panel-title-questions">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="http://wemoga-001-site42.ftempurl.com/#collapseFive">
            ...
            <div class="col-md-6">
                <div>
                    <div style="clear: both;">
                        <img style="height: 30px; float: left;" src="front/009.png">
                ...
                <div class="m-t-30">
                    <div style="clear: both;">
                        <img style="height: 30px; float: left;" src="front/008.png">
                ...
                <div class="m-t-30">
                    <div style="clear: both;">
                        <img style="height: 30px; float: left;" src="front/010.png">
                        ...
                        <ul style="padding: 0; list-style: none; display: inline; margin-left: 15px;">
                            <li style="display: inline;">
                                <img class="imgs-socials-footer" style="" src="front/013.png">
                            </li>

                            <li style="display: inline;">
                                <img class="imgs-socials-footer" style="" src="front/012.png">
                            </li>

                            <li style="display: inline;">
                                <img class="imgs-socials-footer" style="" src="front/011.png">
                            </li>

                            <li style="display: inline;">
                                <img class="imgs-socials-footer" style="" src="front/007.png">
                            </li>
                        </ul>
                    </div>
