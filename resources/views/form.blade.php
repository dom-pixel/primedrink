            ...
            <div class="row">
                ...
                <!-- Circles which indicates the steps of the form: -->
                    ...
                    <div class="tab">
                        ...
                        <div class="m-t-20">
                            <input class="form-control" type="text" name="email" placeholder="Digite o dígito da conta">
                        </div>
                        <div class="m-t-20">
                            <div class="form-group">
                                <span
                    ...
                    <div class="tab">
                        ...
                        <div class="m-t-20">
                            ...
                            <input class="form-control" name="password" type="password" placeholder="Digite uma senha"
                                   required>
                        </div>
                    </div>
